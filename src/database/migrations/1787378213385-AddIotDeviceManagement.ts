...
export class AddIotDeviceManagement1787378213385 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "device_telemetry" ("id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "device_id" character varying NOT NULL, "payload" jsonb NOT NULL, "recorded_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_5f9bf90c963405eac930d5733ed" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "dashboards" ("id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" character varying NOT NULL, "name" character varying NOT NULL, "is_default" boolean NOT NULL DEFAULT false, "widgets" jsonb NOT NULL DEFAULT '[]', CONSTRAINT "PK_1b4b4bc346118e0d335f16c5344" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "devices" ADD CONSTRAINT "FK_0be338738cc41d6eec23629b822" FOREIGN KEY ("template_id") REFERENCES "device_templates"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "device_telemetry" ADD CONSTRAINT "FK_64b7753e53da4770c4a9089a380" FOREIGN KEY ("device_id") REFERENCES "devices"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
