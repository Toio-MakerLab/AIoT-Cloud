...
// Device Templates management is admin/root-only (see the route's own guard).
const ADMIN_ONLY_URLS = new Set(['/device-templates']);
...
function stripRootOnlyGroups(groups: NavGroupType[], isAdmin: boolean): NavGroupType[] {
  return groups
    .map((group) => ({
      ...group,
