...
function ToggleAction({
	...
	action: IDeviceActionFieldDefinition;
	deviceId: string;
}) {
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Send a command to this device. Delivery is a live round-trip — the
					device must be online to receive it.
				</CardDescription>
			</CardHeader>
