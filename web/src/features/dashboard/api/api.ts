...
import type { IDashboard, IDevice, IDeviceTelemetry, IPageDto, ISaveDashboard, ITriggerDeviceAction } from './types';
...
export const deviceApi = {
  ...
  triggerDeviceAction: async (deviceId: string, data: ITriggerDeviceAction): Promise<void> => {
    await apiClient.post<Response<unknown>>(`/devices/${deviceId}/actions`, data);
  },
};
