...
export const authApi = {
  ...
  register: async (data: RegisterInput) => {
    const response = await apiClient.post<Response<AuthUser>>('/auth/register', data);
    return response.data;
  },

  verifyEmail: async (data: VerifyEmailInput) => {
    const response = await apiClient.post<Response<null>>('/auth/verify-email', data);
    return response.data;
  },

  resendVerification: async (data: ResendVerificationInput) => {
    const response = await apiClient.post<Response<null>>('/auth/resend-verification', data);
    return response.data;
  },
