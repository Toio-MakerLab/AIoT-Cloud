				...
				{plaintext ? (
					<>
						<DialogHeader>
							...
							<DialogDescription>
								Copy this value now — it won't be shown again. Configure it as
								the `x-device-secret` header on your device firmware.
							</DialogDescription>
						</DialogHeader>
					...
					<Form {...form}>
						<form onSubmit={form.handleSubmit(handleSubmit)}>
							<DialogHeader>
								...
								<DialogDescription>
									Any device sending this value in the `x-device-secret` header
									will authenticate. Several secrets can be active at once, so
									you can roll one out before revoking the old one.
								</DialogDescription>
							</DialogHeader>
							<FormField
							...
							<DialogFooter>
								<Button
									type="submit"
									disabled={createDeviceSecret.isPending}
								>
									Create
								</Button>
							</DialogFooter>
