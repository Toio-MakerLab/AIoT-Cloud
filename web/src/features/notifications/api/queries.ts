...
export const NOTIFICATION_MESSAGES_QUERY_KEY = 'notification-messages';
...
/** Shared by the mutations below and by the live-alert socket listener (notifications-listener.tsx). */
