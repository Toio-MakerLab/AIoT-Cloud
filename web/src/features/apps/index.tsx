            ...
            <li key={app.name} className="rounded-lg border p-4 hover:shadow-md">
              <div className="mb-8 flex items-center justify-between">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className={`${app.connected ? 'border-primary/30 bg-primary/10 text-primary hover:bg-primary/15 dark:border-primary/40 dark:bg-primary/15 dark:hover:bg-primary/25' : ''}`}
                >
