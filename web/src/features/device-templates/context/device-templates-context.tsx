...
const DeviceTemplatesContext =
	React.createContext<DeviceTemplatesContextType | null>(null);
...
export default function DeviceTemplatesProvider({ children }: Props) {
	...
	return (
		<DeviceTemplatesContext.Provider
...
export const useDeviceTemplates = () => {
	...
	if (!deviceTemplatesContext) {
		throw new Error(
			"useDeviceTemplates has to be used within <DeviceTemplatesContext>",
		);
	}
